(function() {
    ...
    // テストコード
    console.assert(
        assessment('Shinri') === 'Shinriのいいところは情熱です。',
        'Towa診断結果が間違っています'
    );
    console.assert(
        assessment('Hoshiki') === assessment('Hoshiki'),
        '同じ名前が正しく処理されていません'
    );
    console.log(assessment('Shinri'));
    console.log(assessment('Towa'));
    console.log(assessment('Hoshiki'));
    console.log(assessment('Shinri'));
})();
